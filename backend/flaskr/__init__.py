...
def create_app(test_config=None):
    ...
    @app.route("/books")
    def retrieve_books():
        selection = Book.query.order_by(Book.author.asc()).all()
...
#         query = Book.query.order_by(Book.id).all()
#         current_books = paginate(request, query)
...
#     @app.route('/books/<int:book_id>', methods=['PATCH']) #add /rating ???
